...
{
    public class SignUpWithNoVerifyCommandValidator : AbstractValidator<SignUpWithNoVerifyCommandRequestModel>
    {
        #region Fields
        ...
        #region Constructor
        public SignUpWithNoVerifyCommandValidator(IStringLocalizer<AppLocalization> stringLocalizer, IUserService userService)
        {
