...
{
    public class UpdateCourseCommandValidator : AbstractValidator<UpdateCourseCommandRequestModel>
    {
        #region Fields
        ...
        #region Constructor
        public UpdateCourseCommandValidator(IStringLocalizer<AppLocalization> stringLocalizer, ICourseService courseService)
        {
